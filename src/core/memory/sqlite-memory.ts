...
export function saveExecutionMemory(input: { taskId?:string; stepId:number; action:string; result:unknown; status?:"completed"|"failed"|"blocked"|"cancelled"|"outcome_unknown"; correlationId?:string }) {
  withAgentDatabase((db) => {

...
export function saveExecutionWithContext(input: { taskId?:string; stepId:number; action:string; result:unknown; status?:"completed"|"failed"|"blocked"|"cancelled"|"outcome_unknown"; context?:ExecutionContext }) {

...
describe("Git service", () => {
  it("reports status and diff, commits, creates a branch, and switches to it", async () => {
    ...
    expect((await gitCommit(repository, "initial", "git-service-test")).exitCode).toBe(0);
    ...
    await gitBranch(repository, "feature/test");
    await gitCheckout(repository, "feature/test");
